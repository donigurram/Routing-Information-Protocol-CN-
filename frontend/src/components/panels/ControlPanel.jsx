...
export function Toggle({ value, onChange, T }) {
    return (
        <div onClick={() => onChange(!value)} style={{
            ...
            <div style={{
                position: "absolute", top: 2.5, left: value ? 24.5 : 2.5,
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                padding: "0 16px", fontSize: 15, fontWeight: 700, letterSpacing: "1.5px",
                display: "flex", alignItems: "center", gap: 8, flexShrink: 0,
            }}>
                <span style={{ fontSize: 18 }}>▣</span> CONTROL PANEL
                <div style={{
                    marginLeft: "auto", padding: "2px 9px", borderRadius: 20, fontSize: 14,
                ...
                {activeTab === "sim" && (
                    <div>
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: 14, fontWeight: 700, color: T.textMuted, letterSpacing: "1px" }}>
                                SIMULATION
                            </div>
                            <div style={{
                                padding: "2px 9px", borderRadius: 20, fontSize: 14, fontWeight: 700, border: "1px solid",
                        ...
                        {!canStart && (
                            <div style={{ padding: "7px 10px", background: T.warnBg, border: `1px solid ${T.warn}44`, borderRadius: 8, fontSize: 14, color: T.warn, marginBottom: 10 }}>
                        ...
                        <div style={{ marginBottom: 10 }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                                <span style={{ fontSize: 14, fontWeight: 700, color: T.textFaint, letterSpacing: "1px" }}>SPEED</span>
                                <span style={{ fontSize: 14, fontWeight: 700, color: T.accent }}>{animSpeed}×</span>
                            </div>
                            <input type="range" min=".25" max="4" step=".25" value={animSpeed}
                                onChange={e => setAnimSpeed(parseFloat(e.target.value))}
                                style={{ width: "100%", accentColor: T.accent }} />
                            <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, color: T.textFaint, marginTop: 2 }}>
                            ...
                            {[
                                ...
                                <div key={label} style={{
                                    ...
                                    <div>
                                        ...
                                        <div style={{ fontSize: 13, color: T.textFaint, marginTop: 1 }}>{desc}</div>
                                    </div>
            ...
            {/* Presets & clear */}
            <div style={{ borderTop: `1px solid ${T.border}`, padding: "12px 14px 14px", flexShrink: 0, background: T.bg }}>

                <div style={{ fontSize: 14, fontWeight: 700, color: T.textFaint, letterSpacing: "1.5px", marginBottom: 7, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span>SPAWN ROUTERS</span>
                    <input type="number" min={1} max={20} value={presetSize} onChange={e => setPresetSize(parseInt(e.target.value) || 1)} style={{ width: 40, padding: 2, borderRadius: 4, border: `1px solid ${T.border}`, background: T.surface, color: T.text, fontSize: 14, fontFamily: "monospace", textAlign: "center" }} title="Number of routers to spawn" />
                </div>
                <div style={{ display: "flex", gap: 5, marginBottom: 7 }}>
                    {[["▬", "linear"], ["○", "ring"], ["⬡", "mesh"]].map(([icon, key]) => (
                        <button key={key} onClick={() => spawnPreset(key, presetSize)} style={{
                            ...
                            borderRadius: 7, cursor: "pointer", fontSize: 14, fontWeight: 600,
                            fontFamily: "'JetBrains Mono', monospace",
            ...
            <div style={{
                ...
                fontSize: 14, color: T.textFaint, fontFamily: "monospace",
